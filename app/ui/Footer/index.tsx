...
export default function Footer() {
  return (
    <div className="w-full flex flex-col justify-center items-center gap-60 lg:gap-80 mt-60 lg:mt-80">
      <div className="w-[32.18794rem] lg:w-[72.875rem] min-h-[22rem] lg:min-h-[40.125rem] bg-[#0c0e1e] rounded-[50%] shadow-[0px_4px_70px_40px_rgba(0,_41,_255,_0.20)_inset,_0px_4px_100px_100px_rgba(0,_41,_255,_0.20)] relative flex flex-col justify-center items-center py-24">
        <div className="absolute animate-spinAxis shadow-[inset_16px_0_40px_3px_black,_inset_-3px_0_6px_2px_rgba(255,_255,_255,_0.2)] h-[2.45975rem] w-[2.45975rem] lg:w-[6.20875rem] lg:h-[6.20875rem] rounded-[50%] bg-[radial-gradient(115.01%_115.01%_at_24.60%_19.00%,_#0F1122_0%,_#0F1122_65.18%,_#0029FF_94.37%)] -rotate-[105.332deg] right-12 top-12 lg:right-10 lg:top-[5.2rem]"></div>
        <div className="absolute animate-spinAxis shadow-[inset_16px_0_40px_3px_black,_inset_-3px_0_6px_2px_rgba(255,_255,_255,_0.2)] h-[3.44688rem] w-[3.44688rem] lg:w-[8.03931rem] lg:h-[8.03931rem] rounded-[50%] bg-[radial-gradient(115.01%_115.01%_at_24.60%_19.00%,_#0F1122_0%,_#0F1122_65.18%,_#0029FF_94.37%)] -rotate-[146.653deg] left-12 top-9 lg:top-6"></div>
        <div className="absolute animate-spinAxis shadow-[inset_16px_0_40px_3px_black,_inset_-3px_0_6px_2px_rgba(255,_255,_255,_0.2)] h-[1.79669rem] w-[1.79669rem] lg:w-[3.15369rem] lg:h-[3.15369rem] rounded-[50%] bg-[radial-gradient(115.01%_115.01%_at_24.60%_19.00%,_#0F1122_0%,_#0F1122_65.18%,_#FFF_94.37%)] -rotate-[140.595deg] left-40 bottom-3 lg:bottom-12"></div>
