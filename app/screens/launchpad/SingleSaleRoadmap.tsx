    ...
    <div className="flex flex-col justify-start items-start px-1 py-1 lg:py-3 lg:px-3 w-full overflow-auto gap-7">
      {isLoading || !isNil(error) ? (
        ...
        <>
          ...
          <article
            className="prose w-full max-w-none prose-slate lg:prose-lg prose-sm prose-a:break-all prose-headings:font-manuale prose-ul:font-inter prose-a:font-inter prose-em:font-inter prose-strong:font-inter prose-a:text-[#0029ff] text-[#d9d9d9] font-inter prose-p:font-inter prose-fuchsia break-all"
